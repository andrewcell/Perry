...
dependencies {
    ...
    implementation("io.ktor:ktor-server-sessions-jvm:2.0.0-eap-256")
    implementation("io.ktor:ktor-server-auth-jwt-jvm:2.0.0-eap-256")
    dokkaGfmPlugin("org.jetbrains.dokka:jekyll-plugin:1.6.10")
